...
PhaserGame.prototype = {
    ...
    create: function() {
       ...
       joystick = gamepad1.addJoystick(100, 420, 1.2, 'gamepad');
        
        // Add a button to the game (only one is allowed right now)
       button = gamepad1.addButton(400, 420, 1.0, 'gamepad');
    ...
    update: function() {
        ...
        this.player.body.acceleration.x = 4 * joystick.properties.x;
        this.player.body.acceleration.y = 4 * joystick.properties.y;
    ...
    updateDebugText: function() {
        this.directionText.setText("Direction:\n up: " + 
           joystick.properties.up + "\n down: " + 
            joystick.properties.down + "\n left: " + 
            joystick.properties.left + "\n right: " + 
           joystick.properties.right);
        this.rectangularText.setText("Rectangular:\n x: " + 
          joystick.properties.x + "\n y: " + joystick.properties.y);
        this.polarText.setText("Polar:\n distance: " + 
          joystick.properties.distance + "\n angle: " +
            (Math.round(joystick.properties.angle * 100) / 100) + 
            "\n rotation: " + 
            (Math.round(joystick.properties.rotation * 100) / 100));
        this.pushText.setText("Joystick: " + joystick.properties.inUse + 
